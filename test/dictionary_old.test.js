...
describe("test dictionary", function() {
    ...
    d.add("t8",t8);
    it("The d.keys['t8'] should equal ['k1','k2'] and d.pairs['t8']['k1'].name should equal '姓名1'", function() {
        d.keys["t8"][0].should.eql("k1");
        d.keys["t8"][1].should.eql("k2");
        d.pairs["t8"]["k1"].name.should.eql("姓名1");
        d.pairs["t8"]["k1"].order.should.eql(1);
        d.pairs["t8"]["k2"].name.should.eql("姓名2");
        d.pairs["t8"]["k2"].order.should.eql(2);
    });
